...
<div class="container mt-5">
  ...
  <form id="myForm" class="border p-4 bg-white rounded" action="register.php" method="POST">
    ...
    <div class="mb-3">
      ...
      <div class="form-check form-check-inline">
        <input type="checkbox" id="html" class="form-check-input" value="HTML" name="skills[]">
        <label class="form-check-label" for="html">HTML</label>
      </div>
      <div class="form-check form-check-inline">
        <input type="checkbox" id="css" class="form-check-input" value="CSS" name="skills[]" >
        <label class="form-check-label" for="css">CSS</label>
      </div>
      <div class="form-check form-check-inline">
        <input type="checkbox" id="js" class="form-check-input" value="JavaScript" name="skills[]">
